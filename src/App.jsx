  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-screen-2xl mx-auto gap-2">
        <div className="text-6xl font-bold text-white text-center">About Us</div>
      </div>
      <div className="relative z-10 flex flex-col sm:flex-row w-full max-w-screen-2xl mx-auto gap-2 mt-10" style={{ height: '565px' }}>
        <div className="flex-1 p-4 flex items-center justify-center ">
          <img src="./../public/ig1.jpg" alt="image..." className="w-full h-full object-cover hidden sm:block"  />
        </div>
        <div className="flex-1 p-4 flex flex-col justify-center" style={{ height: '632px' }}>
          <div className="text-4xl font-bold text-white sm:text-2xl">Computer Science Engineers Community</div>
          <br />
          <p>
